...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    <div class="card card-7">
      <div class="card-body">
        <form method="POST" action="<?php echo site_url('dashboard/insert_petugas'); ?>">
          <div class="form-group">
            <div class="name">Nama</div>
            <div class="value">
              <div class="input-group">
                <input class="form-control" type="text" name="nama_officer" />
              </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="value">
              <div class="input-group">
                <input class="form-control" type="text" name="username_officer" />
              </div>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="value">
              <div class="input-group">
                <input type="text" class="form-control" name="telepon_officer">
              </div>
            </div>
          </div>
          <div class="form-group">
